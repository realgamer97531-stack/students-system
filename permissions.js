module.exports = [
  { key: 'dashboard', label: 'الداشبورد', path: '/dashboard' },
  { key: 'students_view', label: 'قائمة الطلاب', path: '/students' },
  { key: 'students_add', label: 'تسجيل طالب جديد', path: '/students/new' },
  { key: 'sessions_view', label: 'كل الحصص', path: '/sessions' },
